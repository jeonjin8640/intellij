    ...
    public String setWrite(@ModelAttribute BoardDto boardDto,@RequestParam("file") MultipartFile mf) throws IOException {
        ...
        if( !mf.isEmpty() ){
            ...
            if( !makeFolder.exists() ){
                ...
                String savedPathFileName = fileDir + folderName + "/" + saveFileName;

                /* boardDto => db */
                boardDto.setOrgName(orgName);
                boardDto.setSavedFileName(saveFileName);
                boardDto.setSavedPathFileName(savedPathFileName);
...
//        System.out.println("답글" + boardDto);
    ...
    public String setUpdate(@ModelAttribute BoardDto boardDto,@RequestParam("file") MultipartFile mf) throws IOException {
        if( !mf.isEmpty() ){
            ...
            boardDto.setSavedPathFileName(boardDto.getSavedPathFileName());
