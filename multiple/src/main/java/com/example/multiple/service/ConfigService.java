...
public class ConfigService {
    ...
    public void getCommentChange(int id, String comment){
        configMapper.getCommentChange(id, comment);
    }
    public void getColorChange(int id, String color){
        configMapper.getColorChange(id, color);
    }
    public void getDeleteConfig(String configCode) {
        configMapper.getDeleteConfig(configCode);
    }
    ...
    public void dropBoard(String configCode){ //controller
        configMapper.dropBoard(configCode);//mapper
    }
